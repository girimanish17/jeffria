      ...
      <div class="entry__wrapper"><a class="entry__logo" href="{{url('/')}}"><img class="some-icon" src="{{asset('assets/img/logo-dark.png')}}" alt="Core"><img class="some-icon-dark" src="{{asset('asset/img/logo-light.png')}}" alt="Core"></a>
        ...
        <div class="entry__top">
          ...
          <div class="entry__btns">
            <button class="button-stroke entry__button"><img src="{{asset('assets/img/content/google.svg')}}" alt="Google">Google</button>
            <button class="button-stroke entry__button"><img class="some-icon" src="{{asset('assets/img/content/apple-dark.svg')}}" alt="Apple"><img class="some-icon-dark" src="{{asset('assets/img/content/apple-light.svg')}}" alt="Apple">Apple ID</button>
          </div>
        </div>
