        ...
        <div class="login">
          <div class="login__col">
            <div class="login__wrap">
              <div class="login__preview"><img src="{{asset('assets/img/content/login-pic.png')}}" alt="Login"></div>
              <div class="h4 login__subtitle">Plan includes</div>
            ...
            <div class="login__wrapper">
              ...
              <div class="login__entry">
                <div class="login__top">
                  <div style="text-align: center;" class="login__text">Sign up with Open account</div>
                  <div class="login__btns">
                    <button style="flex:unset;width:100%" class="button-stroke login__button"><img src="{{asset('assets/img/content/google.svg')}}" alt="Google">Google</button>
                    <!-- <button class="button-stroke login__button"><img class="some-icon" src="img/content/apple-dark.svg" alt="Apple"><img class="some-icon-dark" src="img/content/apple-light.svg" alt="Apple">Apple ID</button> -->
                  </div>
                </div>
