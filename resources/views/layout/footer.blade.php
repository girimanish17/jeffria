<div class="popup popup_product js-popup js-popup-product">
    ...
    <div class="popup__wrap js-popup-wrap">
        <div class="product js-product">
            <div class="product__control"><a class="button-white product__button" href="products-add.html">Edit product</a>
                    ...
                    <div class="hit">
                        <div class="hit__head">
                            <div class="title-green hit__title">More like this</div><a
                                class="button-stroke button-small hit__button" href="products-dashboard.html"><span>View
                                    all</span>
    ...
    <div class="popup__wrap js-popup-wrap">
        <div class="share">
            ...
            <div class="share__btns"><a class="button-stroke share__button" href="https://www.facebook.com/ui8.net/"
                    ...
                    </svg></a><a class="button-stroke share__button" href="https://twitter.com/ui8" target="_blank">
...
<div class="popup popup_product js-popup js-popup-claim">
    <div class="popup__overlay js-popup-overlay"></div>
    <div class="popup__wrap js-popup-wrap">
        <div class="product js-product">
            ...
            <div class="product__wrapper">
                <div class="product__details">
                    <div class="product__overview">
                        <div style="margin-top:0" class="product__gallery">
                            <div class="settings__item">
                                <div class="settings__anchor" id="account" data-value="Account"></div>
                                <div class="title-purple settings__title">Salary Claim</div>
                                <div style="margin-bottom:32px;" class="field">
                                    <select class="select" name="salary-claim" id="">
                                        <option value="Salary Claim">Salary Claim</option>
                                        <option value="Report Paid Salary">Report Paid Salary</option>
                                    </select>
                                </div>
                                <div class="settings__fieldset">
                                    <div class="field">
                                        <div class="settings__row">
                                            <div class="field">
                                                <div class="field__label">Claim amount
                                                ...
                                                <div class="field__wrap">
                                                    <input class="field__input" type="text" name="new-password">
                                                </div>
                                            </div>
                                            <div class="field">
                                                <div class="field__label">Claim locked fund
                                                    <div class="tooltip tooltipstered">
                                                        <svg class="icon icon-info">
                                                            <use xlink:href="#icon-info"></use>
                                                        </svg>
                                        ...
                                        <div style="margin-bottom:32px" class="field">
                                            <div class="field__label">Deduct debt
                                                <div class="tooltip tooltipstered">
                                                    <svg class="icon icon-info">
                                                        <use xlink:href="#icon-info"></use>
                                                    </svg>
                                            ...
                                            <div class="field__wrap">
                                                <input class="field__input" type="text" name="old-password">
                                            </div>
                                        </div>
                                        <div class="settings__row">
                                            <div class="field">
                                        ...
                                        <div class="editor">
                                            <div class="editor__label">Summary
                                                <div class="tooltip" title="Summary">
                                                    <svg class="icon icon-info">
                                                        <use xlink:href="#icon-info"></use>
                                                    </svg>
                                                </div>
                                        ...
                                        <button style="margin-top:30px" class="button settings__button">Claim</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="comments__list">
                            <div class="comments__item">
                                ...
                                <div class="comments__details">
                                    ...
                                    <div class="comments__login">@ivawelch</div>
                                    <div class="comments__content">Purchased the pack and loaded it in Adobe xd
                                        (installed fonts as well), some text and titles are off in some screens, is that
                                        a compatibility problem with the latest version of xd?</div>
                                    <div class="comments__control">
                                        <button class="comments__favorite">
                                            <svg class="icon icon-heart">
                                                <use xlink:href="#icon-heart"></use>
