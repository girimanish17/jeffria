...
<body>
    ...
    <div class="page">
        ...
        <header class="header unauthorized" data-id="#header">
                    ...
                    <div class="search__box">
                        ...
                        <div class="search__list">
                            <div class="search__item"><a class="search__link js-popup-open" href="#"
                                    ...
                                    <div class="search__preview"><img srcset="img/content/product-pic-3@2x.jpg 2x"
                                            src="{{asset('assets/img/content/product-pic-3.jpg')}}" alt="Put your title here"></div>
                            ...
                            <div class="search__item"><a class="search__link js-popup-open" href="#"
                                    data-popup=".js-popup-product">
                                    <div class="search__preview"><img srcset="img/content/product-pic-4@2x.jpg 2x"
                                            src="{{asset('assets/img/content/product-pic-4.jpg')}}" alt="Put your title here"></div>
                                    <div class="search__details">
                    ...
                    <div class="search__box">
                        ...
                        <div class="search__list"><a class="search__suggestion" href="shop.html">
                                <div class="customer__avatar">
                                    <img src="{{asset('assets/img/content/avatar-1.jpg')}}" alt="Avatar" style="cursor: default;">
                                </div>
                                <div class="search__details">
                                ...
                                <div class="customer__avatar">
                                    <img src="{{asset('assets/img/content/avatar-2.jpg')}}" alt="Avatar" style="cursor: default;">
                                </div>
                                <div class="search__details">
            ...
            <div class="header__control"><a class="button header__button" href="/products-add.html">
                ...
                <div class="header__item header__item_messages">
                    ...
                    <div class="header__body">
                        ...
                        <div class="header__list"><a class="header__message new" href="message-center.html">
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-1.jpg')}}" alt="Avatar"></div>
                                ...
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-2.jpg')}}" alt="Avatar"></div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-3.jpg')}}" alt="Avatar"></div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-4.jpg')}}" alt="Avatar"></div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-5.jpg')}}" alt="Avatar"></div>
                                <div class="header__details">
                                    <div class="header__line">
                ...
                <div class="header__item header__item_notifications">
                    ...
                    <div class="header__body">
                        ...
                        <div class="header__list"><a class="header__notification new" href="notification.html">
                                <div class="header__avatar"><img src="{{asset('assets/img/content/avatar-1.jpg')}}" alt="Avatar">
                                    <div class="header__icon" style="background-color: #2A85FF;"><img
                                            src="img/content/message.svg" alt="Status"></div>
                                </div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="img/content/avatar-2.jpg" alt="Avatar">
                                    <div class="header__icon" style="background-color: #FF6A55;"><img
                                            src="img/content/heart.svg" alt="Status"></div>
                                </div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="img/content/avatar-3.jpg" alt="Avatar">
                                    <div class="header__icon" style="background-color: #83BF6E;"><img
                                            src="img/content/shopping-bag.svg" alt="Status"></div>
                                </div>
                                <div class="header__details">
                                    <div class="header__line">
                                ...
                                <div class="header__avatar"><img src="img/content/avatar-4.jpg" alt="Avatar">
                                    <div class="header__icon" style="background-color: #8E59FF;"><img
                                            src="img/content/star.svg" alt="Status"></div>
                                </div>
                                <div class="header__details">
                                    <div class="header__line">
                                    ...
                                    <div class="header__content">Rate <img src="img/content/rating-star.svg"
                                            alt="Star" /> <strong>5</strong> for <strong>Smiles – 3D icons</strong>
                                    </div>
                                </div>
                            </a><a class="header__notification" href="notification.html">
                                <div class="header__avatar"><img src="img/content/avatar-5.jpg" alt="Avatar">
                                    <div class="header__icon" style="background-color: #2A85FF;"><img
                                            src="img/content/message.svg" alt="Status"></div>
                                </div>
                                <div class="header__details">
                ...
                <div class="header__item header__item_user">
                    <button class="header__head"><img src="img/content/avatar.jpg" alt="Avatar"></button>
                    <div class="header__body">
                        ...
                        <div style="border-radius: 0px; cursor: unset;" onmouseover="this.style.cursor='pointer'"
                            ...
                            <svg style="margin-right:12px" width="25px" height="25px" viewBox="0 0 24 24"
                                fill="#8E59FF" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="header__btns"><a class="header__link" href="sign-in.html">Sign in</a><a
                    class="button header__button" href="sign-up.html">Sign up</a></div>
        </header>
        <!-- sidebar-->
        <div class="sidebar">
            ...
            </button><a class="sidebar__logo" href="index.html"><img class="some-icon" src="img/logo-dark.png"
                    alt="Core"><img class="some-icon-dark" src="img/logo-light.png" alt="Core"></a>
            <div class="sidebar__menu"><a class="sidebar__item active" href="index.html">
                ...
                <div class="sidebar__item sidebar__item_dropdown wide">
                    <div class="sidebar__top">
                        ...
                        </button><a class="sidebar__add" href="products-add.html">
                    ...
                    <div class="sidebar__body"><a class="sidebar__link" href="products-dashboard.html">Traffic Report
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg></a><a class="sidebar__link" href="products-drafts.html">Under Development
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg>
                ...
                <div class="sidebar__item sidebar__item_dropdown wide">
                    ...
                    <div class="sidebar__body"><a class="sidebar__link" href="customers-overview.html">Overview
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg></a><a class="sidebar__link" href="customer-list.html">Staffs list
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg></a>
                        <a class="sidebar__link" href="affiliate-traffic.html">Affiliate Traffic
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg></a>
                        <a class="sidebar__link" href="salary-claim-status.html">Salary claim status
                            <svg class="icon icon-arrow-next">
                                <use xlink:href="#icon-arrow-next"></use>
                            </svg></a>
                    </div>
        ...
        <div class="help">
            ...
            <div class="help__list"><a class="help__item" data-fancybox
                    href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" data-caption="Use guidelines">
                    <div class="help__preview"><img srcSet="img/content/product-pic-1@2x.jpg 2x"
                            src="img/content/product-pic-1.jpg" alt="Exclusive downloads"></div>
                    <div class="help__details">
                        <div class="help__title">Exclusive downloads</div>
                        <div class="help__line">
                            <div class="status-purple help__status">New</div>
                            <div class="help__user">
                                <div class="help__avatar"><img src="img/content/avatar-1.jpg" alt="Avatar"></div>
                                <div class="help__time">3 mins</div>
                            </div>
                        </div>
                    </div>
                </a><a class="help__item" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                    data-caption="Use guidelines">
                    <div class="help__preview"><img srcSet="img/content/product-pic-2@2x.jpg 2x"
                            src="img/content/product-pic-2.jpg" alt="Behind the scenes"></div>
                    <div class="help__details">
                        <div class="help__title">Behind the scenes</div>
                        <div class="help__line">
                            <div class="status-purple help__status">New</div>
                            <div class="help__user">
                                <div class="help__avatar"><img src="img/content/avatar-2.jpg" alt="Avatar"></div>
                                <div class="help__time">5 mins</div>
                            </div>
                        </div>
                    </div>
                </a><a class="help__item" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                    data-caption="Use guidelines">
                    <div class="help__preview"><img srcSet="img/content/product-pic-3@2x.jpg 2x"
                            src="img/content/product-pic-3.jpg" alt="Use guidelines"></div>
                    <div class="help__details">
                        <div class="help__title">Use guidelines</div>
                        <div class="help__line">
                            <div class="help__user">
                                <div class="help__avatar"><img src="img/content/avatar-3.jpg" alt="Avatar"></div>
                                <div class="help__time">8 mins</div>
                            </div>
                        </div>
                    </div>
                </a><a class="help__item" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                    data-caption="Use guidelines">
                    <div class="help__preview"><img srcSet="img/content/product-pic-4@2x.jpg 2x"
                            src="img/content/product-pic-4.jpg" alt="Life &amp; work update"></div>
                    <div class="help__details">
                        <div class="help__title">Life &amp; work update</div>
                        <div class="help__line">
                            <div class="help__user">
                                <div class="help__avatar"><img src="img/content/avatar-4.jpg" alt="Avatar"></div>
                                <div class="help__time">12 mins</div>
                            </div>
                        </div>
                    </div>
                </a><a class="help__item" data-fancybox href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                    data-caption="Use guidelines">
                    <div class="help__preview"><img srcSet="img/content/product-pic-5@2x.jpg 2x"
                            src="img/content/product-pic-5.jpg" alt="Promote your product"></div>
                    <div class="help__details">
                        <div class="help__title">Promote your product</div>
                        <div class="help__line">
                            <div class="help__user">
                                <div class="help__avatar"><img src="img/content/avatar-5.jpg" alt="Avatar"></div>
                                <div class="help__time">33 mins</div>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="popup popup_product js-popup js-popup-product">
            ...
            <div class="popup__wrap js-popup-wrap">
                <div class="product js-product">
                    <div class="product__control"><a class="button-white product__button"
                    ...
                    <div class="product__wrapper">
                            ...
                            <div class="product__overview">
                                <div class="product__head">
                                    <div class="product__nav">
                                        <button class="product__link js-product-open active">Product</button>
                                    ...
                                    <div class="product__btns">
                                        ...
                                        <button class="button product__buy"><span
                                                class="product__price">$89</span><span
                                ...
                                <div class="product__line">
                                    <div class="product__author">
                                        <div class="product__avatar"><img src="img/content/avatar.jpg"
                                ...
                                <div class="product__gallery">
                                    <div class="product__box"><a class="product__preview"
                                            href="img/content/photo-1.jpg" data-fancybox="gallery"
                                            data-caption="Spectacular views of Queenstown"><img
                                                src="img/content/photo-1.jpg" alt="Product"></a><a
                                            class="product__preview" href="{{asset('assets/img/content/photo-2.jpg')}}"
                                            data-fancybox="gallery"
                                            data-caption="Spectacular views of Queenstown"><img
                                                src="img/content/photo-2.jpg" alt="Product"></a><a
                                            class="product__preview" href="{{asset('assets/img/content/photo-1.jpg')}}"
                                            data-fancybox="gallery"
                                            data-caption="Spectacular views of Queenstown"><img
                                                src="img/content/photo-1.jpg" alt="Product"></a><a
                                            class="product__preview" href="{{asset('assets/img/content/photo-2.jpg')}}"
                                            data-fancybox="gallery"
                                            data-caption="Spectacular views of Queenstown"><img
                                                src="img/content/photo-2.jpg" alt="Product"></a></div><a
                                ...
                                <div class="product__row">
                                    <div class="product__col">
                                        ...
                                        <div class="product__content">
                                            <p>Meet Node - a crypto NFT marketplace iOS UI design kit for Figma, Sketch,
                                                and Adobe XD. The kit includes 126 stylish mobile screens in light and
                                                dark mode, a bunch of crypto 3D illustrations, 1 SaaS landing page with
                                                full premade breakpoints, and hundreds of components to help you ship
                                                your next crypto, NFT product faster.</p>
                                            <p>Types of screens included: onboarding, connect wallet, home feed,
                                                profile, upload, menu, search, product detail, notification...</p>
                                            <p>If you have any questions or requests, please feel free to leave them all
                            ...
                            <div class="hit">
                                <div class="hit__head">
                                    <div class="title-green hit__title">More like this</div><a
                                        ...
                                        href="products-dashboard.html"><span>View all</span>
                                        <svg class="icon icon-arrow-right">
                                            <use xlink:href="#icon-arrow-right"></use>
                                        </svg></a>
                                </div>
                                    ...
                                    <div class="hit__slider js-slider-hit">
                                        <div class="summary">
                                            <div class="summary__preview"><img
                                                    srcSet="img/content/product-pic-1@2x.jpg 2x"
                                        ...
                                        <div class="summary">
                                            <div class="summary__preview"><img
                                                    srcSet="img/content/product-pic-2@2x.jpg 2x"
                                        ...
                                        <div class="summary">
                                            <div class="summary__preview"><img
                                                    srcSet="img/content/product-pic-3@2x.jpg 2x"
                        ...
                        <div class="product__comments comments">
                            ...
                            <div class="comments__list">
                                <div class="comments__item">
                                    ...
                                    <div class="comments__details">
                                        ...
                                        <div class="comments__content">Purchased the pack and loaded it in Adobe xd
                                            (installed fonts as well), some text and titles are off in some screens, is
                                            that a compatibility problem with the latest version of xd?</div>
                                ...
                                <div class="comments__answer">
                                    <div class="comments__avatar"><img src="img/content/avatar.jpg" alt="Avatar">
                                    </div>
                                    <div class="comments__details">
                                        <div class="comments__line">
                        ...
                        <div class="product__panel">
                            <div class="product__avatar"><img src="img/content/avatar.jpg" alt="Avatar"></div>
                            <div class="product__brand"><img src="img/content/figma.png" alt="Figma">
            ...
            <div class="popup__wrap js-popup-wrap">
                <div class="share">
                    ...
                    <div class="share__field">
                        ...
                        <input class="share__input" type="text" name="site"
                            value="https://ui8.net/feel-travel">
                        <button class="share__copy">Copy</button>
                    </div>
                    <div class="share__preview"><img src="img/content/photo-1.jpg" alt="Share"></div>
                    <div class="share__btns"><a class="button-stroke share__button"
                            ...
                            </svg></a><a class="button-stroke share__button"
                            href="https://www.instagram.com/ui8net/" target="_blank">
    ...
    <script src="{{asset('assets/js/lib/tooltipster.bundle.min.js')}}"></script>
